                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="single-input">
                        ...
                        <input type="text" id="company" name="company" class="form-input" placeholder="Введите название вашей компании ">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="single-input">
                        <label for="surname">ИНН</label>
                        <input type="text" id="inn" name="inn" class="form-input" placeholder="Введите ИНН вашей компании">
                      </div>
                    </div>
                    <div class="col-md-7">
                      <div class="single-input">
                    ...
                    <div class="col-md-6">
                      <div class="single-input">
                        ...
                        <input type="password" id="password1" name="password1" class="form-input" placeholder="Введите ваш пароль ещё раз">
                      </div>
                    </div>
                    <div class="col-md-12">
